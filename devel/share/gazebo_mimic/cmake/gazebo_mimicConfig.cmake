...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_mimic_SOURCE_PREFIX /home/cesar/yumi_depends_ws/src/yumi/gazebo_mimic)
  set(gazebo_mimic_DEVEL_PREFIX /home/cesar/yumi_depends_ws/devel)
  ...
  set(gazebo_mimic_INSTALL_PREFIX /home/cesar/yumi_depends_ws/install)
...
if(NOT "/home/cesar/yumi_depends_ws/src/yumi/gazebo_mimic/include " STREQUAL " ")
  set(gazebo_mimic_INCLUDE_DIRS "")
  set(_include_dirs "/home/cesar/yumi_depends_ws/src/yumi/gazebo_mimic/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_mimic' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cesar/yumi_depends_ws/src/yumi/gazebo_mimic/${idir}'.  ${_report}")
    endif()
